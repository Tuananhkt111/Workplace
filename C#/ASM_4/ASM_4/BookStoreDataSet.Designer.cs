...
namespace ASM_4 {
    ...
    public partial class BookStoreDataSet : global::System.Data.DataSet {
        ...
        public partial class BooksDataTable : global::System.Data.TypedTableBase<BooksRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public BooksRow AddBooksRow(string BookName, double BookPrice) {
        ...
        public partial class BooksRow : global::System.Data.DataRow {
            ...
            public double BookPrice {
                get {
                    return ((double)(this[this.tableBooks.BookPriceColumn]));
                }
                set {
...
namespace ASM_4.BookStoreDataSetTableAdapters {
    ...
    public partial class BooksTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Books] WHERE (([BookID] = @Original_BookID) AND ([BookName] = " +
                "@Original_BookName) AND ([BookPrice] = @Original_BookPrice))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Books] ([BookName], [BookPrice]) VALUES (@BookName, @BookPrice" +
                ");\r\nSELECT BookID, BookName, BookPrice FROM Books WHERE (BookID = SCOPE_IDENTITY" +
                "())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Books] SET [BookName] = @BookName, [BookPrice] = @BookPrice WHERE (([BookID] = @Original_BookID) AND ([BookName] = @Original_BookName) AND ([BookPrice] = @Original_BookPrice));
SELECT BookID, BookName, BookPrice FROM Books WHERE (BookID = @BookID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::ASM_4.Properties.Settings.Default.BookStoreConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT BookID, BookName, BookPrice FROM dbo.Books";
        ...
        public virtual int Delete(int Original_BookID, string Original_BookName, double Original_BookPrice) {
            ...
            this.Adapter.DeleteCommand.Parameters[2].Value = ((double)(Original_BookPrice));
        ...
        public virtual int Insert(string BookName, double BookPrice) {
            if ((BookName == null)) {
            ...
            this.Adapter.InsertCommand.Parameters[1].Value = ((double)(BookPrice));
        ...
        public virtual int Update(string BookName, double BookPrice, int Original_BookID, string Original_BookName, double Original_BookPrice, int BookID) {
            if ((BookName == null)) {
                throw new global::System.ArgumentNullException("BookName");
            }
            else {
            ...
            this.Adapter.UpdateCommand.Parameters[1].Value = ((double)(BookPrice));
            ...
            this.Adapter.UpdateCommand.Parameters[4].Value = ((double)(Original_BookPrice));
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string BookName, double BookPrice, int Original_BookID, string Original_BookName, double Original_BookPrice) {
            return this.Update(BookName, BookPrice, Original_BookID, Original_BookName, Original_BookPrice, Original_BookID);
        }
    }
