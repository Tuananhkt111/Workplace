...
namespace PetShop.Controllers
{
    public class AccessoryController : Controller
    {
        ...
        public IActionResult Index()
        {
            ...
            return View(dao.FindAllAcc());
        }
        public IActionResult FindByLikeName(string accSearch)
        {
            AccessoryDAO dao = new AccessoryDAO(_context);
            return View("Index", dao.FindAccByLikeName(accSearch, false));
        }
        [HttpGet]
        ...
        public IActionResult FindByPetCatID(string petCatSearch)
        {
            AccessoryDAO dao = new AccessoryDAO(_context);
            List<DTO.Accessory> list = dao.FindAllAccByPetCatID(petCatSearch);
            return View("Index", list);
        }
        public IActionResult FindByAccCatID(string accCatIDSearch)
        {
            AccessoryDAO dao = new AccessoryDAO(_context);
            List<DTO.Accessory> list = dao.FindAllAccByAccCatID(accCatIDSearch);
            return View("Index", list);
        }
