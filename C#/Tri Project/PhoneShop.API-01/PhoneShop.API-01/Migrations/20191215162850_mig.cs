        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Screen = table.Column<string>(maxLength: 256, nullable: true),
                    OperatingSystem = table.Column<string>(maxLength: 256, nullable: true),
                    FrontCamera = table.Column<string>(maxLength: 256, nullable: true),
                    RearCamera = table.Column<string>(maxLength: 256, nullable: true),
                    Cpu = table.Column<string>(maxLength: 256, nullable: true),
                    Ram = table.Column<string>(maxLength: 256, nullable: true),
                    InternalMemory = table.Column<string>(maxLength: 256, nullable: true),
                    Sim = table.Column<string>(maxLength: 256, nullable: true),
                    BatteryCapacity = table.Column<string>(maxLength: 256, nullable: true)
                },
                constraints: table =>
                {
