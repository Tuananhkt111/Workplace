 ...
 * @author tuana
 */
public class AddToProListController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (roleSession.equals("admin")) {
                ...
                if (dto == null) {
                    dto = new PromotionListDTO();
                }
                if (dto.addProList(new ProListDetailsDTO(userID, 5.0f))) {
                    msg = "Add user to promotion list success";
                } else {
                    msg = "This user is already in promotion list";
                }
