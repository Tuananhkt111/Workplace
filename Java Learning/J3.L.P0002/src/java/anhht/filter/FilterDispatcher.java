...
public class FilterDispatcher implements Filter {
    ...
    private static final String INDEX = "SearchController";
    private static final String NOTFOUND = "notFoundPage.jsp";
    ...
    public FilterDispatcher() {
        ...
        admin.add("Edit");
        admin.add("Insert");
        admin.add("InsertPage");
        admin.add("Logout");
        admin.add("Search");
        admin.add("Update");
        admin.add("InsertUserPage");
        admin.add("InsertUser");
        user = new ArrayList<>();
        user.add("");
        user.add("cart.jsp");
        user.add("AddCart");
