...
@Results({
    ...
    ,
    @Result(name = "success", location = "LoginAction", type = "chain")
    ,
    @Result(name = "failed", location = "InsertUserPageAction", type = "chain")})
public class InsertUserAction {

    private static final Logger LOGGER = Logger.getLogger(InsertUserAction.class);
    ...
    public String execute() throws Exception {
        ...
        try {
            ...
            if (e.getMessage().contains("duplicate")) {
                ...
                LOGGER.error("ERROR at InsertUserAction: " + e.getMessage());
                msg = "ERROR at InsertUserAction";
            }
        }
        return url;
    }
