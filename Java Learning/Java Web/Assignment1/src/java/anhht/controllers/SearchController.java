...
import anhht.dto.SearchErrorObject;
...
public class SearchController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            boolean valid = true;
            SearchErrorObject errorObj = new SearchErrorObject();
            if(min >= max) {                
                valid = false;
                errorObj.setMinMaxError("Min must be smaller than max.");
            }
            if(valid) {
                FoodDAO dao = new FoodDAO();
                List<FoodDTO> result = dao.findByPriceRangeAvailable(min, max);
