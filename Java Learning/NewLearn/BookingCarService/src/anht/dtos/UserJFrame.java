...
public class UserJFrame extends javax.swing.JFrame {
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        if (validate(pass, fullname, phone, age)) {
            if (accDAO.update(new CustomerDTO(accID, fullname, phone, sex, age))) {
    ...
    private void btnBookActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBookActionPerformed
        ...
        if (check) {
            if (ttDAO.insert(new TravelTransactionDTO(transID, travelID, accID, null, null, carName, price, duration, startTime))) {
