...
package data;
public class Dog {
    public static String name; //co the la chi huhu, ngao da,...
    public int yob;  //ngay sinh 
...
//        System.out.println("Weight: " + weight);
    ...
    public static void f()
    {
        ...
        System.out.println("Name: " + name); //static choi voi static
        //System.out.println("Yob: " + yob);
        //non static khong the duoc truy van bang static method
    }
}
