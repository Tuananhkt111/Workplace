...
import anhht.jaxb.demo.Customers;
import java.io.File;
...
private static final String xmlFile = "/WEB-INF/customers.xml";
private static final String VIEW = "view.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Customers cus = (Customers) um.unmarshal(f);           
            request.setAttribute("INFO", cus.getCustomer());
        } catch(Exception e) {
            e.printStackTrace();
        } finally {
