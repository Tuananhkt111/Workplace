                        ...
                        <fo:table border-collapse="separate" table-layout="fixed">
                            ...
                            <fo:table-body>
                                <fo:table-row>
                                    ...
                                    <fo:table-cell border-color="blue"
                                            border-width="0.5pt" border-style="solid">
                                        <fo:block text-align="center">PubDate</fo:block>
                                    </fo:table-cell>
                                    <fo:table-cell border-color="blue"
                                            border-width="0.5pt" border-style="solid">
                                        <fo:block text-align="center">Link</fo:block>
                                    </fo:table-cell>
                                </fo:table-row>
                                <xsl:for-each select="newsDTOes/newsDTO">
                                    <fo:table-row>
                                        <fo:table-cell border-color="blue"
                                            border-width="0.5pt" border-style="solid">
                                            <fo:block text-align="center" font-family="Arial">
                                                <xsl:number level="single" count="newsDTO"/>.
                                            </fo:block>
                                        </fo:table-cell>
                                        <fo:table-cell border-color="blue"
                                            border-width="0.5pt" border-style="solid">
